...
/// <summary>ncolor_data個別色指定(NColorEntry)のスナップショット(2026-07-26)。tick等の同定情報を
...
/// 2026-07-26要望対応: 「frame情報以外は全て保持してコピペしたい」に従い、Ctrl+C/V・Ctrl+ドラッグ複製
